...
alias m2d='mas upgrade'
alias b2d='rm -rf $(brew --cache) && brew update && brew upgrade && brew_cask_upgrade && brew cleanup --force && brew cask cleanup'
alias g2d='gem update'
alias a2d='apm upgrade --no-confirm'
alias s2d='x2d && m2d && b2d && g2d && a2d && . "${HOME}/.bash_profile"'
alias ibl='cd "${HOME}/Library/Mobile Documents/iCloud~com~apple~iBooks/Documents"'
